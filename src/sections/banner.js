...
/*import banner from 'assets/images/Team work_Monochromatic.png';*/
import banner from 'assets/images/Startup.png';
      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.content}>
            <Heading as="h1">
              Vi skapar smarta plattformar.
            </Heading>
            <Text as="p">
              Findler kopplar ihop dig med rätt leverantör snabbt och effektivt. Det kan t ex handla om att knyta ihop kockar med dig som vill ha en maträtt tillagad i hemmet. Vi bygger lösningar som förenklar hela processen. Ange din epost om du är nyfiken!
            </Text>
            <Box sx={styles.subscribe}>
              ...
              />
              <Button variant="primary">Väntelista</Button>
            </Box>
